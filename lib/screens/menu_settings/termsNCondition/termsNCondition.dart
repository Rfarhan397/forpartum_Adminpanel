                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          var formattedDate = '${createdAt.day}/${createdAt.month}/${createdAt.year}'; // Format the date

                          return Card(
                            margin: const EdgeInsets.all(8.0),
                            child: ListTile(
                              title: AppTextWidget(text: termCondition,maxLines: null,textAlign: TextAlign.start,fontWeight: FontWeight.w900,fontSize: 15,),
                              subtitle: AppTextWidget(text: 'Published on: ${formattedDate.toString()}',maxLines: null,textAlign: TextAlign.start,fontWeight: FontWeight.w900,fontSize: 15,),
                              trailing: SizedBox(
                                height: 50,
                                width: 20.w,
                                child: Row(
