                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buildLeftSide(),
                      // Main Chat Window
                      buildRightSide(context, provider),
                    ],
                  ),
                ),
              ),
            ...
            builder: (context, snapshot) {
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  chatRoom.users.firstWhere((user) => user != getCurrentUid());
                  ...
                  return ListTile(
                    ...
                    trailing: chatRoom.isMessage == getCurrentUid() && chatRoom.isMessage !="seen"
                      ...
                      backgroundColor: primaryColor,
                        ...
                        : null,
                    onTap: () async{
                      log("Chat Room ID:: $otherUserEmail");
                      log("Chat Room ID:: ${otherUser.email}");
                      final chatRoomId = await Provider.of<ChatProvider>(context,listen: false).getChatRoom(otherUserEmail,"");
                     var provide  =  Provider.of<ChatProvider>(context,listen: false);
                        ...
                        children: [
                          ...
                          Flexible(
                            child: Container(
                              ...
                              child: StreamBuilder(
                                stream: context.watch<ChatProvider>().getMessages(provider.chatRoomId.isNotEmpty ? provider.chatRoomId : "ss"),
                                builder: (context, snapshot) {
                                  if (snapshot.connectionState == ConnectionState.waiting) {
                                    return const Center(child: CircularProgressIndicator());
                                  }
